...
class DPDCollectionRequestOrders{
    ...
    public function addParcel($array)
    {
        ...
        $this->storeOrderMessage['order']['parcels'][] = [
            ...
            'returns' => ($array['returns'] === true)?true:false,
        ];
    ...
    public function submit()
    {
        ...
        try{
            ...
            $this->airWayBills[] = [
              'dpdReference' => $response->orderResult->shipmentResponses->parcelInformation->dpdReference
            ];
        }
        catch (SoapFault $e)
        {
    ...
    {
      $the_sender = (object) $this->storeOrderMessage['order']['generalShipmentData']['sender'];
      $the_sender_new = clone $the_sender;
      $the_sender_new = (array) $the_sender_new;
      return $the_sender_new;
    }
